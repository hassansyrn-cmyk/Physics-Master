...
///
/// MIT License
/// Copyright(c) 2018 Abdullah Konash
/// </summary>
//-----------------------------------------------------------------------------
...
namespace ArabicSupport
{
    ...
    internal class ArabicFixerTool
    {
                ...
                if (str[i] == (char)0x064B) {
                    ...
                    if (index > 0 && combineTashkeel) {
                        if (tashkeelLocation[index - 1].tashkeel == (char)0x0651) {
                            tashkeelLocation[index - 1].tashkeel = (char)0xFC60;
                            IncrementSB(ref str, i);
                            continue;
                        }
                    }
                    ...
                    if (index > 0 && combineTashkeel) {
                        if (tashkeelLocation[index - 1].tashkeel == (char)0x0651) {
                            tashkeelLocation[index - 1].tashkeel = (char)0xFC61;
                            IncrementSB(ref str, i);
                            continue;
                        }
                    }
                    ...
                    if (index > 0 && combineTashkeel) {
                        if (tashkeelLocation[index - 1].tashkeel == (char)0x0651) {
                            tashkeelLocation[index - 1].tashkeel = (char)0xFC62;
                            IncrementSB(ref str, i);
                            continue;
                        }
                    }
                    ...
                    if (index > 0 && combineTashkeel) {
                        if (tashkeelLocation[index - 1].tashkeel == (char)0x064E) {
                            tashkeelLocation[index - 1].tashkeel = (char)0xFC60;
                            IncrementSB(ref str, i);
                            continue;
                        }

                        if (tashkeelLocation[index - 1].tashkeel == (char)0x064F) {
                            tashkeelLocation[index - 1].tashkeel = (char)0xFC61;
                            IncrementSB(ref str, i);
                            continue;
                        }

                        if (tashkeelLocation[index - 1].tashkeel == (char)0x0650) {
                            tashkeelLocation[index - 1].tashkeel = (char)0xFC62;
                            IncrementSB(ref str, i);
                            continue;
                        }
        ...
        internal static ushort HandleInduNumber(ushort letterOrigin, ushort letterFinal) {
            if (letterOrigin == 0x0030) return 0x0660;
            else if (letterOrigin == 0x0031) return 0x0661;
            else if (letterOrigin == 0x0032) return 0x0662;
            else if (letterOrigin == 0x0033) return 0x0663;
            else if (letterOrigin == 0x0034) return 0x0664;
            else if (letterOrigin == 0x0035) return 0x0665;
            else if (letterOrigin == 0x0036) return 0x0666;
            else if (letterOrigin == 0x0037) return 0x0667;
            else if (letterOrigin == 0x0038) return 0x0668;
            else if (letterOrigin == 0x0039) return 0x0669;
            else return letterFinal;
        }
